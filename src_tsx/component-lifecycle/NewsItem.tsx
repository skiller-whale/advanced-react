...
class NewsItem extends React.Component<Props> {
  render() {
    const { id, headline, content, isFavourite, onToggleFavourite } = this.props
    console.log(`** render news item: ${id} **`)
    return (
          ...
          <div style={{ display: "flex" }}>
            ...
            >
              <path
                ...
                fill={isFavourite ? "#ffc107" : "lightgray"}
              />
            </svg>
            <h4 className="ml-2">{headline}</h4>
          </div>
